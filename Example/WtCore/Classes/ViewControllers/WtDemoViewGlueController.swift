...
class WtDemoViewGlueController: UIViewController {
    ...
    func createDatas() {
        ...
        cellGlue.tableViewDatasource.selector(#selector(UITableViewDataSource.tableView(_:cellForRowAt:)), block: ({ tableView, _ in
        ...
        cellGlue.tableViewDelegate.selector(#selector(UITableViewDelegate.tableView(_:didSelectRowAt:)), block: ({ tableView, indexPath in
        ...
        cellGlue2.tableViewDatasource.selector(#selector(UITableViewDataSource.tableView(_:cellForRowAt:)), block: ({ tableView, _ in
        ...
        cellGlue2.tableViewDelegate.selector(#selector(UITableViewDelegate.tableView(_:heightForRowAt:)), block: ({ _, _ in
            return 100
        ...
        cellGlue3.tableViewDatasource.selector(#selector(UITableViewDataSource.tableView(_:cellForRowAt:)), block: ({ tableView, _ in
        ...
        cellGlue3.tableViewDelegate.selector(#selector(UITableViewDelegate.tableView(_:didSelectRowAt:)), block: ({ tableView, indexPath in
            tableView.deselectRow(at: indexPath, animated: true)
            } as @convention(block) (UITableView, IndexPath) -> Void))
        
        cellGlue3.tableViewDelegate.selector(#selector(UITableViewDelegate.tableView(_:heightForRowAt:)), block: ({ _, _ in
            return 60
            } as @convention(block) (UITableView, IndexPath) -> CGFloat))
    }
}
